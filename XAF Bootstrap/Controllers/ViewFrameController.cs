...
{    
    public partial class ViewFrameController : ViewController
    {
        ...
        protected override void OnActivated()
        {
            ...
            var unsavedDataController = Frame.GetController<DevExpress.ExpressApp.Web.SystemModule.ActionConfirmUnsavedChangesController>();
            if (unsavedDataController != null)
                unsavedDataController.Active["XafBootstrapActive"] = false;

            var resetViewSettingsController = Frame.GetController<DevExpress.ExpressApp.SystemModule.ResetViewSettingsController>();
            if (resetViewSettingsController != null)
                resetViewSettingsController.Active["XafBootstrapActive"] = false;
        }
