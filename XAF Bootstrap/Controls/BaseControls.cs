...
namespace XAF_Bootstrap.Controls
{
    ...
    public class XafBootstrapBaseControl : ASPxCallbackPanel
    {
        ...
        {
            return (String.Concat(ClientID) != "" ? ContentHelper.GetCallbackScript(ClientID, String.Format("{0}", CallbackString)) : "");
        }
        ...
        {
            get {
                return (String.Concat(PropertyName) != "" ? String.Format("{0}_{1}", CallbackClientID, PropertyName) : ID);
            }
        }
